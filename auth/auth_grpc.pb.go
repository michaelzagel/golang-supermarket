...
func (c *authClient) SignIn(ctx context.Context, in *SignInInput, opts ...grpc.CallOption) (*SignInOutput, error) {
...
func (c *authClient) VerifyToken(ctx context.Context, in *VerifyTokenInput, opts ...grpc.CallOption) (*VerifyTokenOutput, error) {
	out := new(VerifyTokenOutput)
...
func (UnimplementedAuthServer) SignIn(context.Context, *SignInInput) (*SignInOutput, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SignIn not implemented")
}
func (UnimplementedAuthServer) VerifyToken(context.Context, *VerifyTokenInput) (*VerifyTokenOutput, error) {
...
func _Auth_SignIn_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).SignIn(ctx, req.(*SignInInput))
	}
...
func _Auth_VerifyToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).VerifyToken(ctx, req.(*VerifyTokenInput))
	}
	return interceptor(ctx, in, info, handler)
}
